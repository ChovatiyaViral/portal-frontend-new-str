...
export const getSalesOrdersRequest = (request) => ({
  types: ["GET_SALES_ORDERS_REQUEST", "GET_SALES_ORDERS_SUCCESS", "GET_SALES_ORDERS_FAILURE"],
  request: (http) => http.post(salesOrdersUri, request),
});

export const cancelSalesOrdersRequest = (request) => ({
  types: ["CANCEL_SALES_ORDERS_REQUEST", "CANCEL_SALES_ORDERS_SUCCESS", "CANCEL_SALES_ORDERS_FAILURE"],
