...
class EditableTagGroup extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (!isEqual(get(prevProps, "tags", []), get(this, "props.tags", [])) || !isEqual(get(prevProps, "isCleared", false), get(this, "props.isCleared", false))) {
      this.setState({
        tags: get(this, "props.tags", []),
        clonedTags: get(this, "props.tags", []),
        selectedTags: get(this, "props.selectedTags", []),
    ...
    return (
      <div className="custom_editable_tags">
        {get(this, "state.selectedTags", []).length === 0 && (
          <div className="mb-3" style={{ color: "#6c757d", fontSize: 12 }}>
        ...
        {tags.map((tag, index) => {
          ...
          const tagElem = (
            <Tag
              className={`edit-tag mb-3 ${selectedTags.indexOf(tag) > -1 ? "active" : ""} `}
              key={tag}
              color={selectedTags.indexOf(tag) > -1 ? "#38479e" : "default"}
              onClick={() => {
