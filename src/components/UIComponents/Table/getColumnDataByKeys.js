            ...
            <>
              {
                <Tooltip placement="top" title={getDisplayElement(dataType, column_name, text)}>
                  {getDisplayElement(dataType, column_name, text, isClickable, record, () => {
...
const getDisplayElement = (dataType, column_name, text, is_clickable, record, callback) => {
  switch (dataType) {
    case "price":
      ...
      if (column_name === "rotation_number" && is_clickable) {
        return (
          ...
          >
            ...
            {get(record, "edit_rotation_num") && <EditOutlined onClick={() => callback()} />}
          </center>
        );
      }
