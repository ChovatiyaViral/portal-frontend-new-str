...
const MyMapComponent = compose(
  ...
  return (
    <GoogleMap
      onClick={(e) => {
        if (props?.draggableState) props?.getCoordsFromMaps(e);
      }}
    ...
    >
      <Marker draggable={props?.draggableState} onDragEnd={(e) => props?.getCoordsFromMaps(e)} position={{ lat: props?.mapsCoords?.lat, lng: props?.mapsCoords?.lng }} onClick={props.onMarkerClick} />
    </GoogleMap>
  );
});
...
const LocationMarker = (props) => {
  ...
  return <MyMapComponent coordsChanged={coordsChanged} mapsCoords={mapsCoords} getCoordsFromMaps={getCoordsFromMaps} onMarkerClick={handleMarkerClick} draggableState={draggableState} />;
};
