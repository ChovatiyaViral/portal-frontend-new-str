  ...
  return (
    <>
      ...
      <div className="bg-white p-4">
        <Button onClick={() => handleAdd()} className="float-right mr-2 mb-3" icon={<PlusOutlined />}>
          Add
        </Button>
        <Table columns={columns} dataSource={productFilterArr}></Table>
        <AddStoreCategory page={"Product Filter"} isAdd={isAdd} showModal={showModal} closeModal={closeModal} selectedData={selectedData} submitCallBack={submitCallBack} />
      </div>
    </>
  );
};
