...
import { CustomInputText as CustomTextInput, CustomInputNumber as CustomNumberInput } from "../../UIComponents/Input/customInput";
...
const AddNewStore = () => {
  ...
  return (
    <div>
        ...
        <Col lg={3} md={6} sm={6} xs={12}>
          ...
          <Select
            ...
            options={
              stateList?.length
                ? stateList.map((el) => {
                    return { value: el?.id, label: el?.state_name };
                  })
                : []
            }
        ...
        <Col lg={3} md={6} sm={6} xs={12}>
          ...
          <Select
            ...
            options={
              countryList?.length
                ? countryList.map((el) => {
                    return { value: el?.id, label: el?.country_name };
                  })
                : []
            }
          ...
          <Select
            ...
            options={
              cityList?.length
                ? cityList.map((el) => {
                    return { value: el?.id, label: el?.city_name };
                  })
                : []
            }
            ...
            <div className="mb-3">
              <div className="d-flex align-items-center mb-2">
                ...
                <div className="d-flex align-items-center ml-3" onClick={() => setMapType("maps")}>
                  ...
                  <label className="mb-0 ml-1" htmlFor="maps">
                    Map
                  </label>
                </div>
                <div className="d-flex align-items-center ml-3" onClick={() => setMapType("manually")}>
                  ...
                  <label className="mb-0 ml-1" htmlFor="manually">
                    Manually
                  </label>
                </div>
              </div>
              <small>
                <b>Map</b> - Using google maps , <b>Manually</b> - Using text fields
              </small>
              <LocationMarker
            ...
            <Row>
              <Col md={6}>
                <CustomTextInput
                  ...
                  type="lattitude"
                  className="mt-0 mb-2 mb-sm-0 maps-input"
                  label="Lattitude"
                />
              </Col>
              <Col md={6}>
                <CustomTextInput
                  ...
                  disabled={mapType === "maps" ? true : false}
                  type="longitude"
                  className="mt-0 mb-2 mb-sm-0 maps-input opacity-50"
                  label="Longitude"
                />
              </Col>
            </Row>
      ...
      <Button type="primary" className="mt-3" icon={<SaveOutlined />} onClick={() => submitForm()}>
        Save Location
      </Button>
    </div>
  );
