    ...
    <Spin spinning={get(props, "isLoading", false)}>
      <div className="common_card_section">
        <Row gutter={[16, 12]}>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 6 }}>
            <InputChange handleChange={handleChange} value={get(conversionObj, "contact_name", "")} type="contact_name" disabled={isEditEligible()} className="mt-0 mb-0 w-100" label="Contact Name" />
          </Col>
          <Col xs={{ span: 24 }} sm={{ span: 6 }}>
            {/* <InputChange
            handleChange={handleChange}
          ...
          /> */}
            <Form layout="vertical">
              <Form.Item label={<span>Phone Number</span>}  className="mt-0 mb-0" validateStatus={get(error, "phone") && "error"} help={get(error, "phone") ? "Enter Valid Phone Number" : ""}>
                <PhoneInput
                  international
                  smartCaret
                  disabled={isEditEligible()}
          ...
          <Col xs={{ span: 24 }} sm={{ span: 6 }}>
            <InputChange disabled={isEditEligible()} handleChange={handleChange} value={get(conversionObj, "email", "")} type="email" className="mt-0 mb-0 w-100" label="Email" />
          </Col>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 6 }}>
            <InputChange handleChange={handleChange} disabled={isEditEligible()} value={get(conversionObj, "postal_code", "")} type="postal_code" className="mt-0 mb-0 w-100" label="Postal Code" />
          </Col>
          <Col xs={{ span: 24 }} sm={{ span: 6 }}>
            <Select
              handleChange={handleChange}
