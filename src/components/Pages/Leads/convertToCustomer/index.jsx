...
const ConvertToCustomer = (props) => {
  ...
  return (
    <Modal title="Convert the lead to a Customer" open={get(props, "isModalVisible", false)} onOk={handleOk} centered okText="Convert Lead" width={1000} onCancel={() => props.handleCancel()}>
        ...
        <Row gutter={[16, 12]}>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 6 }}>
            ...
            <Form layout="vertical">
              <Form.Item label={<span>Phone Number</span>} validateStatus={get(error, "phone") && "error"} help={get(error, "phone") ? "Enter Valid Phone Number" : ""} required className="mt-0 mb-0">
                <PhoneInput
                  international
                  smartCaret
