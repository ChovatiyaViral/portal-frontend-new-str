...
const AddCustomer = (props) => {
  ...
  return (
    <Modal title="Add Customer" maskClosable={false} open={get(props, "isModalVisible", false)} onOk={handleOk} centered okText="Save Customer" width={850} onCancel={() => props.handleCancel()}>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 6 }}>
            ...
            <Form layout="vertical">
              <Form.Item
                ...
                validateStatus={get(error, "phone_no") && "error"}
                help={get(error, "phone_no") ? "Invalid Phone Number" : ""}
                required
                className="mt-0 mb-0"
              >
                <PhoneInput
