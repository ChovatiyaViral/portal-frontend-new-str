import { CloseOutlined, DeleteOutlined, EditOutlined, PaperClipOutlined, SaveOutlined, UndoOutlined, UploadOutlined, EyeOutlined, CloseCircleOutlined } from "@ant-design/icons";
            ...
            {get(details, "user_comments") && (
              <>
                ...
                {get(details, "user_comments", "").length > 40 && (
                  <>
                    ...
                    <Button type="link" size="small" className="mt-2 mb-2" icon={<EyeOutlined />} onClick={() => handleMoreCommentsView(get(details, "user_comments", ""), get(details, "new_value"))}>
                      View More
                    </Button>
                  </>
                )}
              ...
              {!isEditEligible() && (
                <Col xs={{ span: 24 }} sm={{ span: 11, offset: 1 }}>
                  <>
                    ...
                    <div className="mt-3">
                      <div className="common_card_section">
                        <InputTextArea className="mt-0 mb-0 w-100" handleChange={(key, value) => setComments(value)} value={comments} type="comments" label="Add Comments" />
                      </div>
                      <span className="label_text" style={{ marginBottom: 20 }}>
                        UPLOAD DOCUMENTS
                      </span>
                        ...
                        {isUploadRequested && (
                          <>
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                              ...
                              {percent !== 100 && (
                                <Button type="text" icon={<CloseCircleOutlined />} onClick={() => handleRequestCancel()}>
                                  Cancel
                                </Button>
                              )}
                            </div>
