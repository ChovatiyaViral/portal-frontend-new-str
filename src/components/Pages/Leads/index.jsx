...
const LeadsManagement = (props) => {
  ...
  React.useEffect(() => {
    dispatch(setCurrentView("Active Leads"));
  }, []);
  ...
  return (
    <>
      ...
      />
      <div className="bg-white table-responsive-padding Table border-radius-12">
        ...
        <div className=" p-4 table-responsive-padding">
          <ErrorBoundary>
            <SearchWithExportUI
              ...
              isSyncEnabled={true}
              handleSync={() => fetchActiveLeadsList(defaultRequestOptions)}
              columnType={TableColumnsList.ActiveLeads}
              fetchDetails={(payload) => fetchActiveLeadsList(payload)}
