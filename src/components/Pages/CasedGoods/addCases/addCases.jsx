...
} from "../../../UIComponents/Input/customInput";
...
const AddCases = props => {
  ...
  const getItems = () => {
    return [
      {
        key: AddCasesTabs.Basics,
        label: AddCasesTabs.Basics,
        children: (
          <>
            <Row>
      ...
      {
        key: AddCasesTabs.Case,
        label: AddCasesTabs.Case,
        children: (
          <>
            <Row>
              <Col sm={6} xs={12} md={6} lg={4}>
      ...
      {
        key: AddCasesTabs.Preview,
        label: AddCasesTabs.Preview,
        children: (
          <>
  ...
  return (
    <>
      ...
      <div className="bg-white p-4 inventory__add_cases">
        <ErrorBoundary>
          <Tabs defaultActiveKey="1" onChange={callback} activeKey={activeKey} items={getItems()} />
        </ErrorBoundary>
      </div>
    </>
  );
