        ...
        <ErrorBoundary>
          <div className="track_order__summary">
            <div className="track_order__summary__details mb-4">
              ...
              <Row className="mt-4" style={{ fontSize: "0.9rem" }} gutter={[0, 8]}>
                ...
                <Col xs={{ span: 12 }} sm={{ span: 12 }} md={{ span: 8 }} lg={{ span: 5 }}>
            ...
            {get(location, "state.type") !== "view" && (
              <div className="track_order__summary__signature">
                <Button className="float-right mt-3" icon={<SendOutlined />} type="primary" onClick={handleRequestSignatureToggle}>
                  Send E-mail
                </Button>
              </div>
            )}
