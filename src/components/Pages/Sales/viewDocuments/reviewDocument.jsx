...
const ReviewComponent = props => {
  ...
  const getItems = () => {
    return [
      {
        key: "1",
        label: "Review AOS Document",
        children: <DocumentViewer htmlString={aosHtml} />
      },
      {
        key: "2",
        label: "Review SOP Document",
        children: <DocumentViewer htmlString={sopHtml} />
      }
    ];
  };
  ...
  return (
    <div className="review-document">
      ...
      <div className="view-document">
        <Tabs defaultActiveKey="1" onChange={callback} items={getItems()} />
      </div>
      <div>
