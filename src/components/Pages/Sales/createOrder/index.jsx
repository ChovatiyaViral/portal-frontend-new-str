import { EyeOutlined, FolderAddOutlined, InfoCircleOutlined, PlusOutlined } from "@ant-design/icons";
import { getRequestHeader } from "../../../../helpers/service";
import { Button, Col, message, Progress, Row, Tag, Upload } from "antd";
...
import { decimalWithTwoPointsCheck, numberWithCommas } from "../../../../helpers/utility";
...
import PreviousNotesModal from "../orderDetails/previousNotesModal";
...
const AddSpirit = (props) => {
  ...
  return (
    <div className="sales-order-list mt-4">
      <EditCasesModal
      ...
      {historyModalStatus && (
        <PreviousNotesModal
          customerInfo={{
            customer_id: get(props, "salesOrderState.customerDetails.customer_id"),
            customer_name: get(props, "salesOrderState.customerDetails.customer_name"),
          }}
          data={get(props, "salesOrderState.past_orders_summary", [])}
      ...
      <div className="common_card_section">
        <div className="d-flex justify-content-between align-items-center">
          <Button className="add-spirit-button mr-2" icon={<PlusOutlined />} type="primary" onClick={() => setVisible(true)}>
            Add Spirits
          </Button>
          <b>
      ...
      <div className="common_card_section">
        <div className="additional-charges">
          ...
          <hr style={{ marginTop: 0, borderTop: "1px solid #d9d9d9" }} />
          <Row gutter={[16, 0]}>
            ...
            <Col xs={{ span: 24 }} sm={{ span: 4 }}>
              <InputChange disabled={true} value={round(totalValue, 2)} type="unit" required prefix={<span>&#163; </span>} className="mt-0 mb-0" label="Total Cost" />
            </Col>
            <Col xs={{ span: 24 }} sm={{ span: 2 }}>
              <Button type="primary" onClick={handleCharges} icon={<PlusOutlined />} style={{ marginTop: 35 }}>
                Add
              </Button>
            </Col>
          </Row>
        </div>
        <div className="additional-table mt-3">
      ...
      <Row gutter={[16, 16]}>
        <Col xs={{ span: 24 }} sm={{ span: 14 }}>
          <div className="common_card_section" style={{ minHeight: "97%" }}>
            <div className="sales_order__documents_upload__test mt-0">
              <div style={{ display: "flex", alignItems: "center" }}>
                <img src={UploadIcon} alt="upload document" style={{ width: "24px", height: "24px" }} />
                <h6 style={{ fontWeight: 600, marginLeft: "10px" }}>Upload Documents / Images</h6>
              </div>
        ...
        <Col xs={{ span: 24 }} sm={{ span: 10 }}>
          <div className="common_card_section final-detail" style={{ minHeight: "97%" }}>
            <div style={{ display: "flex", alignItems: "center", marginBottom: 30 }}>
              <img src={UploadIcon} alt="upload document" style={{ width: "24px", height: "24px" }} />
              <h6 style={{ fontWeight: 600, marginLeft: "10px" }}>Order Summary</h6>
            </div>
            <Row gutter={[8, 0]}>
      ...
      <div className="common_card_section">
        <Row gutter={[16, 0]}>
          <Col sm={{ span: 24 }}>
            <Button type="primary" className="float-right mb-2" icon={<EyeOutlined />} size="small" htmlType="submit" onClick={() => setHistoryModalStatus(true)}>
              View Past Notes
            </Button>
          </Col>
          <Col xs={{ span: 24 }} sm={{ span: 12 }} className="text-area-sales">
            <InputText
              handleChange={handleChange}
