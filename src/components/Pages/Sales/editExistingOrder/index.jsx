...
import { Checkbox, Col, message, Modal, Row, Spin, Tag } from "antd";
...
import { capitalizeAllLetter, decimalWithTwoPointsCheck, getKeyValuePair, isBlank } from "../../../../helpers/utility";
      ...
      <Spin spinning={spiritsLoader}>
        <div className="add-spirit-modal">
          ...
          <Row gutter={[16, 0]}>
            ...
            <Col xs={{ span: 24 }} md={{ span: 12, offset: 12 }} style={get(newCase, "free_item", false) ? { marginTop: "-10%" } : {}}>
              <Row gutter={[16, 10]}>
