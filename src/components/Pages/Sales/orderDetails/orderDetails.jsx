import { CheckOutlined, EditOutlined, EyeOutlined, PlusOutlined, PrinterOutlined, ReloadOutlined, SaveOutlined, CloseCircleOutlined } from "@ant-design/icons";
...
import "./index.scss";
import PreviousNotesModal from "./previousNotesModal";
      ...
      <ErrorBoundary>
        <Spin spinning={get(props, "loading", false)}>
          <>
            ...
            {historyModalStatus && (
              <PreviousNotesModal
                ...
                customerInfo={{
                  ...
                  customer_name: get(props, "customer_name"),
                }}
                isOpen={historyModalStatus}
                handleClose={() => setHistoryModalStatus(false)}
              />
            )}
              ...
              <Row gutter={[16, 16]}>
                <Col sm={{ span: 12 }}>
                  <div className="common_card_section">
                    <Row style={{ fontSize: "0.9rem" }} gutter={[16, 8]}>
                      <Col xs={{ span: 24 }}>
                      ...
                      <Col xs={{ span: 12 }} sm={{ span: 6 }} md={{ span: 12 }} lg={{ span: 8 }}>
                      ...
                      <Col xs={{ span: 12 }} sm={{ span: 6 }} md={{ span: 12 }} lg={{ span: 8 }}>
                        <Text type="secondary">Customer No:</Text>
                ...
                <Col sm={{ span: 12 }}>
                  <div className="common_card_section">
                    <Row style={{ fontSize: "0.9rem" }} gutter={[16, 8]}>
                      ...
                      <Col xs={{ span: 12 }} sm={{ span: 6 }} md={{ span: 12 }} lg={{ span: 10 }}>
            ...
            <div className="common_card_section">
              <Text className="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <span style={{ margin: "0 0 5px 0" }} className="d-flex align-items-center">
                  ...
                  {get(permissions, "approve_foc_items") && (
                    <Button className="float-right ml-2" style={{ position: "relative", zIndex: 8 }} icon={<CheckOutlined />} type="link" onClick={() => setApproveFOCModalStatus(true)}>
                      {getScreenSize() > isMobileOrTab && "Approve Free Items"}
                    </Button>
                  )}
                  {get(permissions, "add_items") && (
                    <Button className="float-right ml-2" style={{ position: "relative", zIndex: 8 }} icon={<PlusOutlined />} type="primary" onClick={() => setVisible(true)}>
                      {getScreenSize() > isMobileOrTab && "Add Spirits"}
                    </Button>
                  )}
                  {get(permissions, "packing_list") && (
                    <Button type="primary" className="float-right ml-2" style={{ position: "relative", zIndex: 8 }} icon={<PrinterOutlined />} onClick={() => handlePrintPackingListDownload()}>
                      {getScreenSize() > isMobileOrTab && "Packing List"}
                    </Button>
                  )}
                </span>
              </Text>
              ...
              <>
                <div className="common_card_section float-left w-100">
                  ...
                  <Row className="mt-0 mt-4 float-right">
                    <Col>
                      <Button type="secondary" htmlType="reset" icon={<ReloadOutlined />} onClick={() => handleAddedSpiritsReset()}>
                        Reset
                      </Button>
                      <Button
                        type="primary"
            ...
            <div className="common_card_section float-left w-100">
              <Text className="d-flex align-items-center justify-content-between mb-2">
                ...
                {get(permissions, "modify_additional_charges") && (
                  <Button className="float-right ml-2" style={{ position: "relative", zIndex: 8 }} icon={<PlusOutlined />} type="primary" onClick={() => setAddAdditionalChargesModal(true)}>
                    {getScreenSize() > isMobileOrTab && "Add Charges"}
                  </Button>
                )}
              </Text>
              <hr style={{ backgroundColor: "#ccd5df", margin: "5px 0 10px" }} />
            ...
            <div className="common_card_section order__details_count float-left w-100">
              <Row style={{ fontSize: "12px" }} gutter={[0, 8]}>
              ...
              <Row gutter={[16, 0]}>
                <Col xs={{ span: 24 }} sm={{ span: 24 }}>
                  <Text className={getScreenSize() > isMobileOrTab ? "d-flex align-items-center justify-content-between mb-2" : ""}>
                    <span style={{ fontWeight: 500, fontSize: 16, marginRight: 20 }}> Additional Details </span>
                    {(get(permissions, "modify_special_conditions") || get(permissions, "modify_notes")) && (
                      <Button type="primary" className="float-right" icon={<EyeOutlined />} size="small" htmlType="submit" onClick={() => setHistoryModalStatus(true)}>
                        {getScreenSize() > isMobileOrTab && "View Past Notes"}
                      </Button>
                    )}
                  </Text>
                  <hr style={{ backgroundColor: "#ccd5df", margin: "5px 0 10px" }} />
                  ...
                  {get(permissions, "modify_special_conditions") ? (
                    <>
                      ...
                      <div className="float-right mt-2">
                        <Button type="link" icon={<CloseCircleOutlined />} onClick={() => setSpecialConditions(get(props, "special_conditions", ""))}>
                          Cancel
                        </Button>
                        <Button type="primary" htmlType="submit" icon={<SaveOutlined />} className="ml-3" onClick={() => handleSaveSpecialConditions()}>
                          Save
                        </Button>
                      </div>
                    </>
                ...
                <Col xs={{ span: 24 }} sm={{ span: 12 }}>
                  {get(permissions, "modify_notes") ? (
                    <>
                      ...
                      />
                      <div className="float-right mt-2">
                        <Button type="link" icon={<CloseCircleOutlined />} onClick={() => setNotes(get(props, "notes", ""))}>
                          Cancel
                        </Button>
                        <Button type="primary" icon={<SaveOutlined />} htmlType="submit" className="ml-3" onClick={() => handleSaveNotes()}>
                          Save
                        </Button>
                      </div>
                    </>
                    ...
                    <>
                      <InputTextArea note="(for internal team visibility)" className="mt-0 mb-0 w-100" autoSize={false} disabled type="notes" value={get(props, "notes")} label="Notes" />
                    </>
                  )}
                </Col>
              </Row>
