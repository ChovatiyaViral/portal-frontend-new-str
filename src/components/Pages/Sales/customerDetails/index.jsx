...
const CustomerDetailsEntry = (props) => {
  ...
  const updateNewCase = (detail, selectedCustomer) => {
    ...
    newProd.past_orders_summary = [...detail.past_orders_summary];
  ...
  return (
    <div className="sales_order__customer_details">
      ...
      <div className="sales_order__customer_details__add common_card_section mt-4">
        <Row gutter={[16, 0]}>
          <Col xs={{ span: 24 }} sm={{ span: 10 }} lg={{ span: 8 }}>
            <Select
      ...
      <div className="common_card_section">
        <div className="sale-order-divider">
          <p className="text-black">Details below are pre filled basis customer profile and the last Sales Order from this customer. Please change as required.</p>
          <hr />
        </div>

        <Row gutter={[16, 0]}>
          <Col xs={{ span: 24 }} sm={{ span: 8 }} md={{ span: 6 }} lg={{ span: 6 }}>
            <InputChange
              handleChange={handleChange}
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 8 }} md={{ span: 6 }} lg={{ span: 6 }}>
            <InputChange
              ...
              type="vat_no"
              required={get(props, "salesOrderState.customerDetails.country") === "United Kingdom"}
              maxLength={100}
              className="mt-0 mb-0 w-100"
          ...
          <Col xs={{ span: 24 }} sm={{ span: 8 }} md={{ span: 6 }} lg={{ span: 6 }}>
            <InputChange
              ...
              maxLength={100}
              type="eori_no"
              className="mt-0 mb-0 w-100 eori__number__style"
              validateStatus={get(error, "eori_no") ? "error" : ""}
              helpText={get(error, "eori_no") ? "EORI No cannot be empty" : <span style={{ color: "#faad14" }}>Mandatory for delivery to EU countries</span>}
              label="EORI No"
            />
          </Col>
          <Col xs={{ span: 24 }} sm={{ span: 8 }} md={{ span: 6 }} lg={{ span: 6 }}>
            <InputChange
              ...
              label="Excise Reg. No of Place of Delivery"
            />
          </Col>
        </Row>
      </div>
