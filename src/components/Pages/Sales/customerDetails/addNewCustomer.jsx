import { ArrowRightOutlined, PlusOutlined, CloseCircleOutlined } from "@ant-design/icons";
          ...
          footer={[
            !isEmpty(addNewCustomerRes) && addNewCustomerRes.status && (
              <div className="customer-footer-text">
                ...
                <Button type="link" icon={<ArrowRightOutlined />} onClick={() => setModalOpen(false)}>
        ...
        >
          <div className="sales-order-modal">
            ...
            <div className="customer-footer-button">
              <Button type="text" icon={<CloseCircleOutlined />} onClick={() => setModalOpen(false)}>
                Cancel
              </Button>
              <Button type="primary" icon={<PlusOutlined />} onClick={this.handleCreateCustomer}>
