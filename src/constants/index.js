...
export const TableColumnsList = {
  ...
  CRRList: "CRR List",
  CaskMasterList: "Cask Master List",
  PassportMasterList: " Passport Master List",
  DocumentsViewList: "Document View List",
  SamplingHistory: "Sampling History",
  SpiritTransfer: "Spirit Transfer",
  PendingSamplingData: "Pending Sampling Data",
  CompletedSamplingData: "Completed Sampling Data",
  CancelledSamplingData: "Cancelled Sampling Data",
  RegaugeList: "Regauge List",
  RegaugePendingList: "Regauge Pending List",
};
